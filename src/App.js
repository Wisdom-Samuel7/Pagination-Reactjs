...
function App() {
 ...
 const data =  [
     ...
     {"id":15,"todo":"Clean out car","completed":false,"userId":33},{"id":16,"todo":"Draw and color a Mandala","completed":true,"userId":24},
     ...
     {"id":23,"todo":"Plan a trip to another country","completed":true,"userId":37},{"id":24,"todo":"Improve touch typing","completed":false,"userId":45},
     {"id":25,"todo":"Learn Express.js","completed":false,"userId":49},{"id":26,"todo":"Learn calligraphy","completed":false,"userId":50},
  ...
  return (
    ...
    <div className="App">
      ...
      <input
       className='px-10 py-2 rounded-md hover:px-16 m-2 bg-black text-red-500' 
     ...
     <div className='flex flex-col space-x-4 justify-center items-center '>
       {
         data.filter(el=> el.todo.toLowerCase().includes(search))
         .map((value)=>{
          return <h1 className=' text-orange-300 '> <a href={value.userId}> {value.todo} </a></h1>
         })
       }
      </div>
